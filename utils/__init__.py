...
class Labelme2YOLO(object):
    ...
    def __init__(self, json_dir, src_img_path):
    ...
    def convert(self, val_size):
        ...
        for target_dir, json_names in zip(('train/', 'val/'),
            ...
            for json_name in json_names:
                ...
                self._save_yolo_label(json_data, json_name,
    ...
    def _get_polygon_shape_yolo_object(self, shape, img_h, img_w):
        ...
        x_lists = [round(port[0] / img_w, 6) for port in shape['points']]
        y_lists = [round(port[1] / img_h, 6) for port in shape['points']]
    ...
    def _save_yolo_label(self, json_data, json_name, label_dir_path, target_dir, yolo_obj_list):
        ...
        with open(txt_path, 'w+') as f:
            ...
            for yolo_obj_idx, yolo_obj in enumerate(yolo_obj_list):
                yolo_label, x_list, y_list = yolo_obj
    ...
    def _save_yolo_image(self, json_name, image_dir_path, target_dir):
        ...
        if not os.path.exists(img_path):
            shutil.copyfile(os.path.join(self.src_img_path, img_name), img_path)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--json_dir', type=str, default=r"D:\AICUP\Badminton\dataset\Public\labels_for_ball_small",
    ...
    convertor = Labelme2YOLO(args.json_dir, args.json_dir)
