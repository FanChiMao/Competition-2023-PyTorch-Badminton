...
def smooth(path, save_path):
    ...
    for i in range(len(df)):
        if af_dis[i] > 30 and vis2[i] == 1:
            if bf_dis[i] > 30 and vis2[i] == 1:
                ...
                if af_dis[i + 1] < 30 and af_dis[i + 2] < 30 and af_dis[i + 3] < 30 and af_dis[i + 4] < 30 and af_dis[
                    i + 5] < 30:
    ...
    for i in range(len(mis2)):
        if i == 0 or i == 1 or i == 2 or i == len(mis2) or i == len(mis2) - 1 or i == len(mis2) - 2:
            ...
            miss_point = i
            if mis1_X[miss_point - 3] != 0 and mis1_X[miss_point - 2] != 0 and mis1_X[miss_point - 1] != 0 and mis1_X[
                miss_point + 2] != 0 and mis1_X[miss_point + 3] != 0 and mis1_X[miss_point + 4] != 0:
                num_X = [mis1_X[miss_point - 3], mis1_X[miss_point - 2], mis1_X[miss_point - 1], mis1_X[miss_point + 2],
                         mis1_X[miss_point + 3], mis1_X[miss_point + 4]]
                num_y = [mis1_y[miss_point - 3], mis1_y[miss_point - 2], mis1_y[miss_point - 1], mis1_y[miss_point + 2],
    ...
    for i in range(len(mis3)):
        if i == 0 or i == 1 or i == 2 or i == len(mis3) or i == len(mis3) - 1 or i == len(mis3) - 2:
            ...
            miss_point = i
            if mis2_X[miss_point - 3] != 0 and mis2_X[miss_point - 2] != 0 and mis2_X[miss_point - 1] != 0 and mis2_X[
                miss_point + 3] != 0 and mis2_X[miss_point + 4] != 0 and mis1_X[miss_point + 5] != 0:
                num_X = [mis2_X[miss_point - 3], mis2_X[miss_point - 2], mis2_X[miss_point - 1], mis2_X[miss_point + 3],
                         mis2_X[miss_point + 4], mis2_X[miss_point + 5]]
                num_y = [mis2_y[miss_point - 3], mis2_y[miss_point - 2], mis2_y[miss_point - 1], mis2_y[miss_point + 3],
    ...
    for i in range(len(mis4)):
        if i == 0 or i == 1 or i == 2 or i == len(mis4) or i == len(mis4) - 1 or i == len(mis4) - 2:
            ...
            miss_point = i
            if mis3_X[miss_point - 3] != 0 and mis3_X[miss_point - 2] != 0 and mis3_X[miss_point - 1] != 0 and mis3_X[
                miss_point + 4] != 0 and mis3_X[miss_point + 5] != 0 and mis3_X[miss_point + 6] != 0:
                num_X = [mis3_X[miss_point - 3], mis3_X[miss_point - 2], mis3_X[miss_point - 1], mis3_X[miss_point + 4],
                         mis3_X[miss_point + 5], mis3_X[miss_point + 6]]
                num_y = [mis3_y[miss_point - 3], mis3_y[miss_point - 2], mis3_y[miss_point - 1], mis3_y[miss_point + 4],
    ...
    for i in range(len(mis5)):
        if i == 0 or i == 1 or i == 2 or i == 3 or i == len(mis5) or i == len(mis5) - 1 or i == len(mis5) - 2:
            ...
            miss_point = i
            if mis4_X[miss_point - 3] != 0 and mis4_X[miss_point - 2] != 0 and mis4_X[miss_point - 1] != 0 and mis4_X[
                miss_point + 5] != 0 and mis4_X[miss_point + 6] != 0 and mis4_X[miss_point + 7] != 0:
                num_X = [mis4_X[miss_point - 3], mis4_X[miss_point - 2], mis4_X[miss_point - 1], mis4_X[miss_point + 5],
                         mis4_X[miss_point + 6], mis4_X[miss_point + 7]]
                num_y = [mis4_y[miss_point - 3], mis4_y[miss_point - 2], mis4_y[miss_point - 1], mis4_y[miss_point + 5],
    ...
    df.to_csv(os.path.join(save_path, os.path.basename(path)), index=False)


# path = r"D:\AICUP\Competition-2023-PyTorch-Badminton\utils\predict_process\predict_public_test_csv\00002_predict.csv"
# smooth(path, 'test')
