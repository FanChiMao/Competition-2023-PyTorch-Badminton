...
@register_model
def mae_teacher_vit_base_patch16(pretrained=False, **kwargs):
...
@register_model
def mae_teacher_vit_large_patch16(pretrained=False, **kwargs):
    model = MaskedAutoencoderViT(
...
@register_model
def mae_teacher_vit_huge_patch14(pretrained=False, **kwargs):
    model = MaskedAutoencoderViT(
